...
import { Radar, PolarAngleAxis, PolarGrid, PolarRadiusAxis, RadarChart, ResponsiveContainer, Tooltip } from "recharts";
			...
			<div style={{ width: "100%", height: 300 }}>
				<ResponsiveContainer>
					<RadarChart cx='50%' cy='50%' outerRadius='80%' data={customerSegmentationData}>
						...
						/>
						<Radar name='Segment A' dataKey={"A"} fill='#8B5CF6' fillOpacity={0.6} />
						<Radar name='Segment B' dataKey={"B"} fill='#10B981' fillOpacity={0.6} />
					</RadarChart>
				</ResponsiveContainer>
			</div>
		</motion.div>
